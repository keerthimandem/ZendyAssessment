 ...
 *
 */
public class TestNgIReporterImpl implements IReporter{
	
	private static final Logger LOG = Logger.getLogger(TestNgIReporterImpl.class);
	...
	private String dReportFileName = "TestReport-"+z+".html";
    ...
    public void generateReport(List<XmlSuite> xmlSuites, List<ISuite> suites, String outputDirectory) {
        ...
        //    writer = createWriter(outputDirectory);
            writer = createWriter("C:\\Assessment\\BasicReports\\");
        } catch (IOException e) {
        ...
        if (!classResults.isEmpty()) {
            ...
            for (ClassResult classResult : classResults) {
                ...
                for (MethodResult methodResult : classResult.getMethodResults()) {
                    ...
                    // Date 
                  Long l = new Long(TimeUnit.MINUTES.convert(startTime.getTimeInMillis() - endTime.getTimeInMillis(),TimeUnit.MILLISECONDS));
				  String inSeconds = null ;
					  if(l==0 || l.equals(0)) {
					 Long k = new Long(TimeUnit.SECONDS.convert(Math.abs(startTime.getTimeInMillis() -
					   endTime.getTimeInMillis()),TimeUnit.MILLISECONDS));
					 inSeconds = k.toString();
					  }
                    ...
                    buffer.append("<td><a href=\"#m").append(scenarioIndex)
                          ...
                          //  .append("\">").append(failureScreenShot)
                            .append("\">").append(inSeconds == null ? l.toString()+" Min" : inSeconds+" Seconds"  )
                            .append("</td>").append("<td rowspan=\"")
    ...
    protected void writeStackTrace(Throwable throwable) {
        writer.print("<div class="+throwable.getMessage()+">");
